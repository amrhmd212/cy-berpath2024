...
typedef struct {
    Position posi_robot;
    int num_robot;
} Robot; // Structure robot qui contient la structure position et le numéro du robot

typedef struct{
  int num_joueur;
  int nombre_coup;
  int nombre_point;
} Joueur; //structure joueur qui permet de stocker le numéro du joueur, le nombre de coup et le nombre de point
